    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "8200 broadway st", "apt 711n", "houston", new DateTime(2020, 4, 20, 4, 30, 11, 827, DateTimeKind.Local).AddTicks(2465), "wolnguyen98@gmail.com", "thuy nguyen", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ifSjo941edEh7y0/a6ar5/5Q/EoXdmuxBSd8UyxroS4=", new byte[] { 4, 88, 24, 186, 60, 25, 56, 52, 4, 179, 251, 218, 53, 20, 155, 59 }, "tx", "", "" });

            migrationBuilder.InsertData(
                table: "Customer",
                columns: new[] { "CustomerId", "Address1", "Address2", "City", "DateCreated", "Email", "Fullname", "LastLogin", "PasswordHashed", "PasswordSalt", "State", "Zip4", "Zip5" },
                values: new object[] { 2, "8956 Sage St", "", "Benton Harbor", new DateTime(2020, 4, 20, 4, 30, 11, 831, DateTimeKind.Local).AddTicks(4724), "cmphan7@gmail.com", "cuong phan", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ifSjo941edEh7y0/a6ar5/5Q/EoXdmuxBSd8UyxroS4=", new byte[] { 4, 88, 24, 186, 60, 25, 56, 52, 4, 179, 251, 218, 53, 20, 155, 59 }, "MI", "", "49022" });

            migrationBuilder.InsertData(
                table: "Customer",
                columns: new[] { "CustomerId", "Address1", "Address2", "City", "DateCreated", "Email", "Fullname", "LastLogin", "PasswordHashed", "PasswordSalt", "State", "Zip4", "Zip5" },
                values: new object[] { 3, "457 Illinois Road", "", "Monsey", new DateTime(2020, 4, 20, 4, 30, 11, 831, DateTimeKind.Local).AddTicks(4778), "kimnguyen137@gmail.com", "kim nguyen", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ifSjo941edEh7y0/a6ar5/5Q/EoXdmuxBSd8UyxroS4=", new byte[] { 4, 88, 24, 186, 60, 25, 56, 52, 4, 179, 251, 218, 53, 20, 155, 59 }, "ny", "", "10952" });
